                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <!-- <td style="text-align: center;"><a href="trangchu.php?add=<?php echo $array["id_cv"];?>"><input name="quanTam" type="submit" value="❤"
                                        ...
                                        <td style="text-align: center;"><a href="admin.php?delete=<?php echo $array["id_cv"];?>"  style="background-color:white; color: red; font-size: 20px;text-decoration: none;">Xóa</a></td> 
