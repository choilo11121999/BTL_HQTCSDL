...
<?php
            ...
            $sqlite = "select id_cv , viTriTuyenDung , tenCty , luong , khuVuc , hanNopHs from congViec order by id_cv DESC ";
            ...
            //     $khuvuc = $_POST['khuvuc'];
            //     $_SESSION['tencv'] = $ten_cv;
            //     $_SESSION['nganh'] = $nganh;
            //     $_SESSION['khuvuc'] = $khuvuc;
                // if(!empty($_POST['tenCv']) || !empty($_POST['nganhTuyen']) || !empty($_POST['khuvuc'])){
                //     header('location:timiem.php');
                // }
                // else{
    ...
    <div class="khungnoidung">
        <div class="noidung">
            <div class="viecmoinhat">
                ...
                <form action="trangchu.php?dn=trangchu" method="POST">
                    <table class="table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <!-- <td style="text-align: center;"><a href="trangchu.php?add=<?php echo $array["id_cv"];?>"><input name="quanTam" type="submit" value="❤"
                                        style="background-color:white; color: red; font-size: 20px;"></a></td> -->
                                <td style="text-align: center;"><a href="trangchu.php?add=<?php echo $array["id_cv"];?>"  style="background-color:white; color: red; font-size: 20px;text-decoration: none;">❤</a></td>
